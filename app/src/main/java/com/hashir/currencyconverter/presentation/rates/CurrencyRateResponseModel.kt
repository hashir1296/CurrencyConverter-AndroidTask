...
data class CurrencyRateResponseModel(
    ...
    @Json(name = "conversion_rates") val conversionRates: ConversionRates?,
    ...
    data class ConversionRates(
        ...
        @Json(name = "SLE") val sLE: Double?,
        @Json(name = "SLL") val sLL: Double?,
        @Json(name = "SOS") val sOS: Double?,
        @Json(name = "SRD") val sRD: Double?,
        @Json(name = "SSP") val sSP: Double?,
        @Json(name = "STN") val sTN: Double?,
